...
venue: "UCL Qatar"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Room 2B01, UCL Qatar Library, Humanitarium, Education City"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "Qatar"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "25.318391,51.444066"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "October 16-17, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 1:30 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Armin Straube", "Amirah Al Sarraj", "Somia Salim"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
<p>
  ...
  {% endif %}
  workshop,
  you will need to bring a laptop with access to the software described below.
  In addition, you will need an up-to-date web browser and access to a spreadsheet programm (e.g. Excel, Open Office, Google Sheets)
</p>
<p>
